    ...
    <body>
            ...
            <c:choose>
                <c:when test="${fn:contains(exception.class.canonicalName, 'ConfirmCartException')}">
                    <c:choose>
                       ...
                       <c:when test="${bindingResult.errorCount gt 0}"> 
                          Your customer data has errors. Please use the checkout button to edit.                                  
               ...
               <c:when test="${fn:contains(exception.class.canonicalName, 'MethodNotSupported')
                ...
                <c:otherwise>
                    View not accessible. You may be using the Browser list, History or Favorites to navigate.
                    <a href="<c:url value='/home' />"  class='alert-link'>
                             Return Home</a>
                </c:otherwise>
           </c:choose> 
        ...
        <div class="message">  
             ...
             <c:if test="${not fn:contains(exception.class.canonicalName, 'MethodNotSupported')
                ...
                <h5 class="subtitle">View not accessible. </h5>
                <h5> You may be using the Browser List, History or Favorites to navigate.</h5>
