...
<table   class="custInfoTbl">
    ...
    <tr>
        ...
        <tr>
          ...
          <tr>
            <td><label><span style="float:left">Country:</span>
                    <span class="asterick">*</span></label>          
                <br/>   
            </td>
            ...
            <form:errors path="addressId.cityId.countryId.countryId" cssClass="bindingErr"></form:errors> 
            </td>
            <td><span id="err_country" class="bindingErr"></span></td>
        </tr>
        <tr>
            ...
            <td style="vertical-align: top">
            <select id="citySelect"  style="clear:both"> 
                <option value="">Please select a city</option>                                               
            </select>
            <form:hidden path="addressId.cityId.cityId" id="cityId" />    
    ...
    <tr>
        ...
        <td>
            <form:select path="addressId.district" id="state" style="height:30px;margin-top:0px">
                <form:option value="" label="Please select a State" />
                <form:options
                    items="${sessionScope.statesList}" itemValue="stCode" itemLabel="stName" />           
            </form:select>
